...
//----------------------------------------------------------------------------//
//
package com.xenoage.zong.util.xml; //proxymusic.util;
 ...
 * @version $Id: HelloWorld.java,v 1.4 2009/04/28 19:35:57 hbitteur Exp $
 */
    ...
    extends TestCase
{
        ...
        throws Exception
    {
        System.out.println(
            ...
            ZongMarshalling.specificationTitle + " specificationVersion:" +
            ZongMarshalling.specificationVersion + " implementationVersion:" +
            ZongMarshalling.implementationVersion);
    }
    	...
    	throws Exception
    {
        ...
        ZongMarshalling.marshal(scorePartwise, os);
    	...
    	throws Exception
    {
        ...
        ScorePartwise scorePartwise = ZongMarshalling.unmarshal(is, false);
    ...
    private ScorePartwise getScorePartwise ()
    {
        ...
        //OBSOLETE note.getContent().add(factory.createNotePitch(pitch));
        note.setPitch(pitch);
        pitch.setStep(Step.C);
        pitch.setOctave(4);

        // Duration
        //OBSOLETE note.getContent().add(factory.createNoteDuration(new BigDecimal(4)));
        note.setDuration(new BigDecimal(4));

        // Type
        NoteType type = factory.createNoteType();
        type.setValue("whole");
        //OBSOLETE note.getContent().add(factory.createNoteType(type));
        note.setType(type);
