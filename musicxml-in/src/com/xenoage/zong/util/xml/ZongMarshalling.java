...
//----------------------------------------------------------------------------//
//
//modified for Zong! by Andreas Wenger
package com.xenoage.zong.util.xml;
 ...
 * 
 * Modified for Zong!: unmarshall without resolving entities (use
 * second resolveEntities method)
 *
 * @author Herv&eacute Bitteur
 * @author Andreas Wenger
 */
public class ZongMarshalling
{
     ...
     *
     * @param is               the input stream
     * @param resolveEntities  true, if entities should be resolved, otherwise false
     * @return                 the scorePartwise root element
     * @exception JAXBException if unmarshalling goes wrong
     */
    public static ScorePartwise unmarshal(InputStream is, boolean resolveEntities)
        throws JAXBException, SAXException, ParserConfigurationException
    {
    	...
    	else
    	{
    		...
    		xmlReader.setEntityResolver(new NoResolver());  
    		SAXSource saxSource = new SAXSource(xmlReader,inSrc);  
    		return (ScorePartwise) u.unmarshal(saxSource);  
    	}
    }
                                  ...
                                  boolean       injectSignature)
    {
        ...
        if (injectSignature &&
            ...
            try {
                ...
                Logger.getLogger(ZongMarshalling.class.getName())
