...
public class BarlineStyleReader
{
	...
	@MaybeNull public static BarlineStyle read(MxlBarStyle mxlBarStyle)
	{
		switch (mxlBarStyle)
		{
			...
			case LightLight: return BarlineStyle.LightLight;
			case LightHeavy: return BarlineStyle.LightHeavy;
			case HeavyLight: return BarlineStyle.HeavyLight;
			case HeavyHeavy: return BarlineStyle.HeavyHeavy;
			case Tick: return null; //not supported
			case Short: return null; //not supported
