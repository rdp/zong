...
public enum BarlineStyle
{
	...
	/**
	 * Double barline with a thin line followed by a thick one.
	 * Usually used as the final barline and for repeat ends.
	 */
	LightHeavy,
	
	/**
	 * Double barline with a thick line followed by a thin one.
	 * Usually used for repeat ends.
	 */
	HeavyLight,
