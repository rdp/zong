 ...
 * 
 * A volta is never used within a voice, but only in the {@link MeasureColumnHeader}.
  ...
  extends NoVoiceElement
{
  ...
  /**
	 * Return this volta, since this class is immutable.
	 */
	@Override public Volta deepCopy(Voice parentVoice, DeepCopyCache cache)
	{
		return this;
	}
