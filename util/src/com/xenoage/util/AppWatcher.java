...
public class AppWatcher
{
  ...
  public void alive(String appID, UUID instanceID)
  {
    ...
    if (!appDir.exists())
    {
      if (!appDir.mkdir())
      {
        Log.log(Log.WARNING, this, "Could not create app folder: " + appDir);
        return;
      }
    }
    ...
    if (instanceFile.exists())
    {
      ...
      {
        Log.log(Log.WARNING, this, "Could not touch file: " + instanceFile);
      }
    }
    else
    {
      ...
      {
        Log.log(Log.WARNING, this, "Could not create file: " + instanceFile);
      }
    }
  }
  ...
  public void dead(String appID, UUID instanceID)
  {
    ...
    if (!instanceFile.exists())
    {
      Log.log(Log.WARNING, this, "Could not mark as dead, since file doesn't exist: " + instanceFile);
    }
    else
    {
      if (!instanceFile.delete())
      {
        Log.log(Log.WARNING, this, "Could not mark as dead, since could not delete file: " + instanceFile);
      }
    }
