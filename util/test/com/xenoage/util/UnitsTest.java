...
public class UnitsTest
{
  ...
  @Test public void mmToPxAndMmToPxFloat()
  {
    ...
    assertEquals(Units.mmToPxFloat(25.4f, scaling), 72, Delta.DELTA_FLOAT);
    assertEquals(Units.mmToPx(25.4f, scaling), 72);
    assertEquals(Units.mmToPxFloat(0.35277778f, scaling), 1, Delta.DELTA_FLOAT);
    assertEquals(Units.mmToPx(0.35277778f, scaling), 1);
    //double scaling
    scaling = 2;
    //144 dpi, so 12.7 mm must be 72 px
    assertEquals(Units.mmToPxFloat(12.7f, scaling), 72, Delta.DELTA_FLOAT);
    assertEquals(Units.mmToPx(12.7f, scaling), 72);
  }
